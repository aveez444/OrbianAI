        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 lg:gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex gap-4 mt-8">
              ...
              <a
                href="https://www.linkedin.com/company/orbianai/?viewAsMember=true"
                target="_blank"
                rel="noreferrer"
                className="w-10 h-10 rounded-full bg-slate-800/50 flex items-center justify-center text-slate-400 hover:bg-emerald-500 hover:text-white transition-all duration-300 hover:scale-110 hover:shadow-lg hover:shadow-emerald-500/25"
                aria-label="LinkedIn"
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3 group">
                ...
                <a href="mailto:info@orbianai.com" className="text-slate-400 hover:text-emerald-400 transition-colors break-all">
                  info@orbianai.com
                </a>
              </div>
              <div className="flex items-start gap-3 group">
