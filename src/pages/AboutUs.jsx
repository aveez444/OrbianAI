              ...
              <div className="flex items-center gap-4 mt-8">
                ...
                <div>
                  <div className="flex items-center gap-3">
                    ...
                    <a href="https://www.linkedin.com/company/orbianai/about/?viewAsMember=true" target="_blank" rel="noreferrer" className="text-slate-400 hover:text-emerald-400 transition-colors" aria-label="LinkedIn">
