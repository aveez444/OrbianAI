              ...
              <div className="flex items-center gap-4 mt-8">
                ...
                <div>
                  <div className="flex items-center gap-3">
                    <h4 className="text-white font-semibold text-lg">Kayyum Sheikh</h4>
                    <a href="https://www.linkedin.com/in/kayyum-sheikh-5b958213/?viewAsMember=true" target="_blank" rel="noreferrer" className="text-slate-400 hover:text-emerald-400 transition-colors" aria-label="LinkedIn">
            ...
            <div className="flex flex-col lg:flex-row items-center justify-between gap-8 relative z-10">
              ...
              <div className="flex flex-col sm:flex-row gap-4 flex-shrink-0">
               <button
                ...
                className="group relative px-8 py-4 bg-emerald-500 text-[#020617] font-bold rounded-xl overflow-hidden transition-all hover:scale-105 hover:shadow-xl hover:shadow-emerald-500/25"
              >
