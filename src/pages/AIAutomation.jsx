// services/AIAutomation.jsx
import { motion, useScroll, useTransform } from "framer-motion";
import { useRef } from "react";

import heroImage from "../assets/ai-automation-hero.png";
import featureImage from "../assets/ai-automation-feature.png";
...
const capabilities = [
  ...
  },
  {
    ...
    body: "Off-the-shelf models rarely fit your specific use case. We fine-tune LLMs on your data, build retrieval-augmented generation (RAG) pipelines, and integrate them securely into your existing stack.",
    tags: ["GPT-4", "Llama 3", "RAG", "LangChain", "Embeddings"],
  },
  {
    number: "03",
...
const process = [
  ...
  },
  {
    ...
    duration: "Week 3–5",
    desc: "A working proof-of-concept with your data. You see the model in action, test its accuracy, and validate the business case before we commit to full engineering.",
  },
  {
    phase: "Production Engineering",
    duration: "Week 6–16+",
    desc: "We harden the system for the real world. Scalable inference pipelines, error handling, logging, and security reviews. AI that works when it matters.",
  },
  {
    phase: "Measurement & Iteration",
    duration: "Ongoing",
    desc: "Model drift, performance metrics, and user feedback loops. We set you up to retrain and improve your models without vendor lock-in.",
  },
];

const techStack = [
  "Python", "PyTorch", "TensorFlow", "LangChain", "LlamaIndex",
  "OpenAI", "Claude", "Hugging Face", "Weaviate", "Pinecone",
  "Docker", "Ray", "MLflow", "Kubeflow", "AWS SageMaker",
  "GCP Vertex AI", "Azure AI", "Redis", "PostgreSQL", "FastAPI",
];

const stats = [
  { value: "85%", label: "Avg. reduction in manual processing time" },
  { value: "3.5×", label: "ROI across delivered automation projects" },
  { value: "99.2%", label: "Model accuracy on structured data tasks" },
  { value: "15+", label: "Production AI systems deployed" },
];

const differentiators = [
  {
    title: "We don't sell black boxes",
    body: "Every model we deploy is explainable. You know why it made a decision, how confident it was, and when to override it. No mystery, no liability.",
  },
  {
  ...
  },
  {
    ...
    body: "AI isn't set-and-forget. We build feedback loops, drift detection, and retraining pipelines so your automation improves over time, not degrades.",
  },
];
      ...
      <section ref={heroRef} className="relative min-h-screen flex flex-col justify-end overflow-hidden">
        ...
        >
          ...
          >
            ...
            <br />
            <span className="text-white/90">That Actually Works</span>
          </motion.h1>
          ...
          >
            ...
            >
              <span className="relative z-10">Automate Your Workflow</span>
  ...
  <div className="container mx-auto px-5 lg:px-12">
    ...
    <div className="space-y-0 divide-y divide-slate-800/50">
      ...
      <section className="py-10 lg:py-16">
        <div className="container mx-auto px-5 lg:px-12">
          <RevealText>
            <h3 className="text-2xl font-bold text-white mb-6 uppercase tracking-wider text-center">LLM Pipeline Production Architecture</h3>
