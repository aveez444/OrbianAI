      ...
      <section className="relative min-h-screen flex items-center overflow-hidden bg-[#020617]">
        ...
        <div className="container mx-auto px-6 relative z-20">
          <div className="max-w-3xl">
            ...
            >
              OrbianAI delivers scalable AI services and predictive frameworks
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-4">
              ...
              <span className="block text-emerald-400 mt-1">Choose Our services</span>
            </h2>
              ...
              <div className="bg-slate-900/30 backdrop-blur-sm rounded-2xl p-6 border border-slate-800">
                ...
                <div className="space-y-4">
                  {[
                    ...
                    { title: 'Enterprise Security', desc: 'Robust security for all data in transit' },
                    { title: 'Scalable Infrastructure', desc: 'Deploy across robust servers with ease' },
                  ].map((item, idx) => (
          ...
          >
            <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
              <div className="text-center sm:text-left">
                <h3 className="text-xl sm:text-2xl font-bold text-white mb-1">Ready to scale your AI services?</h3>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <p className="mt-6 text-slate-500 leading-relaxed max-w-xl">
                ...
                systems, our AI architects engineer services that
